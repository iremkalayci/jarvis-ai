...
<head>
    ...
    <style>
        ...
        .product-icon {
            ...
            box-shadow: 0 0 14px rgba(0,243,255,0.16);
        }
        ...
        .product-disabled:hover {
            ...
            box-shadow: 0 0 18px rgba(255,77,109,0.08);
        }

        .product-disabled .product-title-area h3,
        .product-disabled p,
        .product-disabled .product-price {
            color: #ffffff !important;
            text-shadow: none !important;
        }

        .product-disabled .product-icon {
            color: #ffffff;
                ...
                <div class="product-bottom">
                    ...
                    <div class="product-actions">
                        <a href="<?= base_url('urun/' . $product['id']) ?>" class="btn-detail">
                            <i class="bi bi-file-earmark-text"></i> Detay
                        </a>

                        <?php if ($isAvailable): ?>
                            <a href="<?= base_url('sepete-ekle/' . $product['id']) ?>" class="btn-cart">
                                <i class="bi bi-cart3"></i> Sepete Ekle
                            </a>
                        <?php else: ?>
                            <span class="btn-disabled">
                                <i class="bi bi-slash-circle"></i> Stokta Yok
                            </span>
                        <?php endif; ?>
                    </div>
                </div>
